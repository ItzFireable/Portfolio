...
const projects = ref([
  ...
  {
    title: "Friday Night Funkin': VS. Camellia",
    banner: "camellia.jpg",
    direction: "right",
    link_desc: "View the mod on GameBanana",
